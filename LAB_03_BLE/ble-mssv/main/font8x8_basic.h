...
//vì màn hình 128 x 64 pixel => để hiển thị lên màn hình ta cần mảng 2 chiều:
//tượng trưng cho biểu diễn ký tự ASCII thành pixel 8 COM (D0-D7) mỗi PAGE là 8 cột
//số hàng tương ứng với số lượng ký tự ASCII
//tham khảo hình ảnh: https://vi.m.wikipedia.org/wiki/T%E1%BA%ADp_tin:ASCII-Table-wide.svg
